 ...
 */
public class ColorMomentActivity extends FragmentActivity implements BaseActivityMethodsInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        makeTransaction(new FragmentColorMoment(),getSupportFragmentManager(),R.id.content_frame);
