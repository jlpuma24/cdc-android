...
import co.com.script.conciertodeconciertos.fragments.FragmentColorMoment;
import co.com.script.conciertodeconciertos.fragments.FragmentMap;
import co.com.script.conciertodeconciertos.interfaces.BaseActivityMethodsInterface;

/**
 * Created by User on 18/05/2015.
 */
public class MapsActivity extends FragmentActivity implements BaseActivityMethodsInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        makeTransaction(new FragmentMap(),getSupportFragmentManager(),R.id.content_frame);
