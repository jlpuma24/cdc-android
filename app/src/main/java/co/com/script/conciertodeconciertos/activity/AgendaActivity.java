 ...
 */
public class AgendaActivity extends FragmentActivity implements BaseActivityMethodsInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        makeTransaction(new FragmentAgenda(),getSupportFragmentManager(),R.id.content_frame);
